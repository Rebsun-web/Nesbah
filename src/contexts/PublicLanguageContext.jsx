...
export const translations = {
  ...
  onboarding: {
    ...
    cityPh: { ar: 'مثال: الرياض', en: 'e.g. Riyadh' },
    sector: { ar: 'القطاع', en: 'Sector' },
    sectorPh: { ar: 'مثال: تجزئة، مطاعم، خدمات', en: 'e.g. Retail, Restaurants, Services' },
    ...
    amount: { ar: 'المبلغ التقريبي المطلوب', en: 'Approximate Amount Needed' },
    amountPh: { ar: 'اختر المبلغ التقريبي', en: 'Select approximate amount' },
    amountOptions: [
      { ar: 'أقل من 250 ألف ريال', en: 'Less than 250K SAR' },
      { ar: '250 ألف – 1 مليون ريال', en: '250K – 1M SAR' },
      { ar: '1 مليون – 5 مليون ريال', en: '1M – 5M SAR' },
      { ar: 'أكثر من 5 مليون ريال', en: 'More than 5M SAR' },
    ],
    ...
    consent: { ar: 'بإرسال الطلب، أوافق على الشروط والأحكام وسياسة الخصوصية، وأوافق على مشاركة بياناتي مع جهات التمويل المشاركة.', en: 'By submitting, I agree to the Terms & Conditions and Privacy Policy, and consent to sharing my data with participating financing providers.' },
    ...
    financingTypes: [
      ...
      { ar: 'تمويل رأس المال العامل', en: 'Working Capital' },
      { ar: 'تمويل التوسع', en: 'Expansion Financing' },
      { ar: 'تمويل المعدات', en: 'Equipment Financing' },
      { ar: 'تمويل المشاريع', en: 'Project Financing' },
      { ar: 'تمويل المشاريع العقارية', en: 'Real Estate Project Financing' },
      { ar: 'تمويل نقاط البيع', en: 'POS Financing' },
      { ar: 'أخرى', en: 'Other' },
    ],
    reviewLabels: {
      businessName: { ar: 'اسم الشركة', en: 'Business Name' },
