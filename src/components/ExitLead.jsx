...
export default function ExitLead() {
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            You have purchased a lead but has not submit any offer. If you leave this page you will not be able to submit an offer anymore
                                        </p>
                                    </div>
                                </div>
                            </div>
