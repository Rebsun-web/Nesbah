            ...
            `}>
                <div className="flex items-center justify-between h-14 sm:h-16 px-4 sm:px-6 border-b border-gray-200 bg-gradient-to-r from-purple-600 to-purple-700 rounded-t-2xl mb-4 sm:mb-6">
                    <div className="flex items-center">
                        <span className="ml-2 text-base sm:text-lg font-semibold text-white">Admin Panel</span>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <nav className="mt-4 sm:mt-6 px-4 sm:px-6 mb-4 sm:mb-6">
                        ...
                        {navigation.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`
                                        group flex items-center px-3 sm:px-4 py-2 sm:py-3 text-sm font-medium rounded-md w-full text-left transition-colors
                                        ${isActive 
