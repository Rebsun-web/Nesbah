...
export default function AdminNavbar({ onMenuClick, adminUser, onLogout }) {
    ...
    return (
        <nav className="bg-white shadow-lg border-b border-gray-200 rounded-2xl mb-4 sm:mb-6 ml-4 sm:ml-14 mr-4 sm:mr-24 mt-0">
                ...
                <div className="flex items-center space-x-2 sm:space-x-4">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-lg sm:text-xl font-bold text-gray-900 leading-tight">Nesbah Admin</span>
                            <span className="text-xs text-gray-500 font-medium hidden sm:block">System Administrator</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-2 sm:space-x-4">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center space-x-2 sm:space-x-3 p-2 rounded-xl text-gray-600 hover:text-gray-800 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all duration-200"
                        >
                        ...
                        {userMenuOpen && (
                            <div className="absolute right-0 mt-3 w-56 sm:w-64 rounded-xl shadow-xl bg-white ring-1 ring-black ring-opacity-5 z-50 border border-gray-100">
                                <div className="py-2">
                                    {/* User info header */}
                                    <div className="px-3 sm:px-4 py-3 border-b border-gray-100 bg-gray-50 rounded-t-xl">
                                    ...
                                    <div className="py-1">
                                        <button 
                                            onClick={onLogout}
                                            className="w-full text-left px-3 sm:px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 flex items-center space-x-3 transition-colors duration-150"
                                        >
