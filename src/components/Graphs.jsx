...
export default function Graphs() {
    ...
    return (
        <div className="max-w-7xl w-full bg-white rounded-lg shadow-sm dark:bg-gray-800">
            ...
            <div
                className="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between mt-5 p-4 md:p-6 pt-0 md:pt-0">
                <div className="flex justify-between items-center pt-5">
                    ...
                    <a
                        ...
                        Sales Report
                        <svg className="w-2.5 h-2.5 ms-1.5" aria-hidden="true"
