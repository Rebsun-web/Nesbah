...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed bottom-6 end-6 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-medium text-white shadow-elevated transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95 sm:px-5"
    >
      <WhatsAppSVG />
