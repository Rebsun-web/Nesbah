...
export async function POST(req) {
    try {
        console.log('🧪 Creating new 5-minute test application...');
        
        const client = await pool.connectWithRetry(2, 1000, 'create-new-5min-app');
        ...
        try {
            ...
            const posAppResult = await client.query(
                ...
                [
                    ...
                    now, // submitted_at
                    'New 5-minute test application for background task testing',
            ...
            console.log('✅ New 5-minute test application created successfully!');
            ...
            return NextResponse.json({
                success: true,
                message: 'New 5-minute test application created successfully',
                data: {
                    application_id,
                    user_id: 736,
        ...
        console.error('❌ Error creating new 5-minute test application:', error);
        return NextResponse.json(
            { success: false, error: 'Failed to create new 5-minute test application' },
            { status: 500 }
        );
    }
}
