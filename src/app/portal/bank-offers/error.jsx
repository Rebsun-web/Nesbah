...
export default function Error({
  ...
  useEffect(() => {
    ...
    console.error('Bank Offers Error:', error)
  }, [error])
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                  <div className="text-center">
                    ...
                    <p className="text-red-700 mb-4">
                      {error?.message || 'An unexpected error occurred while loading the bank offers.'}
                    </p>
                    <div className="space-y-3">
                      ...
                      <button
                        onClick={() => window.location.href = '/portal/bank-offers'}
